...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Условия использования - Строительная компания ЛЕГИОН - Правила пользования сайтом в Санкт-Петербурге и Ленинградской области" },
    { name: "description", content: "Условия использования сайта ООО «ЛЕГИОН» в Санкт-Петербурге и Ленинградской области. Ознакомьтесь с правилами пользования нашим сайтом перед началом использования." },
    { name: "keywords", content: "условия использования, правила сайта, пользовательское соглашение, ООО ЛЕГИОН, строительная компания СПб, правила пользования сайтом, юридическая информация, условия предоставления услуг" },
    { name: "author", content: "Строительная компания ЛЕГИОН" },
    { name: "email", content: "l-legion@bk.ru" },
    { rel: "canonical", href: "https://xn--78-glchqprh.xn--p1ai/terms" }, // https://легион.рф/terms
    { property: "og:type", content: "website" },
    { property: "og:url", content: "https://xn--78-glchqprh.xn--p1ai/terms" }, // https://легион.рф/terms
    { property: "og:title", content: "Условия использования - Строительная компания ЛЕГИОН - Правила пользования сайтом в Санкт-Петербурге и Ленинградской области" },
    { property: "og:description", content: "Условия использования сайта ООО «ЛЕГИОН» в Санкт-Петербурге и Ленинградской области. Ознакомьтесь с правилами пользования нашим сайтом перед началом использования." },
    { property: "og:image", content: "/Logo-1.png" },
    { name: "twitter:card", content: "summary_large_image" },
    { name: "twitter:title", content: "Условия использования - Строительная компания ЛЕГИОН - Правила пользования сайтом в Санкт-Петербурге и Ленинградской области" },
    { name: "twitter:description", content: "Условия использования сайта ООО «ЛЕГИОН» в Санкт-Петербурге и Ленинградской области. Ознакомьтесь с правилами пользования нашим сайтом перед началом использования." },
