...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    { rel: "canonical", href: "https://xn--78-glchqprh.xn--p1ai/vacancies" }, // https://легион.рф/
    { property: "og:type", content: "website" },
    { property: "og:url", content: "https://xn--78-glchqprh.xn--p1ai/vacancies" }, // https://легион.рф/
