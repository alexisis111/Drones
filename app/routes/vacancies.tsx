...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Вакансии | ООО ЛЕГИОН — Работа в строительной компании." },
    ...
    { property: "og:title", content: "Вакансии | ООО ЛЕГИОН — Работа в строительной компании." },
    ...
    { name: "twitter:title", content: "Вакансии | ООО ЛЕГИОН — Работа в строительной компании." },
