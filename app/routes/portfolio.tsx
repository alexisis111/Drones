...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Портфолио | ООО ЛЕГИОН — Выполненные проекты." },
    ...
    { property: "og:title", content: "Портфолио | ООО ЛЕГИОН — Выполненные проекты." },
    ...
    { name: "twitter:title", content: "Портфолио | ООО ЛЕГИОН — Выполненные проекты." },
