...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Политика конфиденциальности - ООО «ЛЕГИОН» - Защита персональных данных в Санкт-Петербурге и Ленинградской области" },
    ...
    { property: "og:title", content: "Политика конфиденциальности - ООО «ЛЕГИОН» - Защита персональных данных в Санкт-Петербурге и Ленинградской области" },
    ...
    { name: "twitter:title", content: "Политика конфиденциальности - ООО «ЛЕГИОН» - Защита персональных данных в Санкт-Петербурге и Ленинградской области" },
