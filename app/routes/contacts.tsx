...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Контакты | ООО ЛЕГИОН — Строительная компания." },
    ...
    { property: "og:title", content: "Контакты | ООО ЛЕГИОН — Строительная компания." },
    ...
    { name: "twitter:title", content: "Контакты | ООО ЛЕГИОН — Строительная компания." },
