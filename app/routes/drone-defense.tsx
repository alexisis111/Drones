...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Антидроновая защита от БПЛА | Строительная компания ЛЕГИОН — Защита периметра по СП 542.1325800.2024" },
    ...
    { property: "og:title", content: "Антидроновая защита от БПЛА | Строительная компания ЛЕГИОН — Защита периметра по СП 542.1325800.2024" },
    ...
    { name: "twitter:title", content: "Антидроновая защита от БПЛА | Строительная компания ЛЕГИОН — Защита периметра по СП 542.1325800.2024" },
