...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Услуги | Строительная компания ЛЕГИОН — Антидроновая защита и строительство." },
    ...
    { property: "og:title", content: "Услуги | Строительная компания ЛЕГИОН — Антидроновая защита и строительство." },
    ...
    { name: "twitter:title", content: "Услуги | Строительная компания ЛЕГИОН — Антидроновая защита и строительство." },
