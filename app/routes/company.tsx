...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "О компании | Строительная компания ЛЕГИОН — Антидроновая защита и строительство." },
    ...
    { property: "og:title", content: "О компании | Строительная компания ЛЕГИОН" },
    ...
    { name: "twitter:title", content: "О компании | Строительная компания ЛЕГИОН" },
