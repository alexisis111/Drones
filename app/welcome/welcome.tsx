        ...
        <main className="relative">
            ...
            <div className="relative container mx-auto px-4 z-10">
              <div className="grid lg:grid-cols-2 gap-12 items-center py-8">
                ...
                >
                  ...
                  >
                    <span className="block">Защита от БПЛА</span>
                    <span className="block bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
                    Строим в любом регионе
                  </span>
                    <span className="block">Компания «ЛЕГИОН»</span>
                  </motion.h1>
                  ...
                  >
                    Монтаж антидрон сетки по СП 542, защита периметра от дронов для ТЭЦ, нефтебаз, аэропортов. Строительство под ключ в Ленинградской области и по всей России.
                  </motion.p>
            ...
            <div className="container mx-auto px-4">
              ...
              >
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                  Почему выбирают ЛЕГИОН для защиты от БПЛА
                </h2>
                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  Комплексный подход к защите периметра от дронов и строительно-монтажным работам в Санкт-Петербурге и Ленинградской области
                </p>
              </motion.div>
                ...
                {[
                  {
                    ...
                    description: "Строгое соблюдение договорных обязательств при монтаже антидрон сетки и строительстве в СПб и ЛО"
                  },
                  {
                    icon: <CheckCircle className="w-8 h-8" />,
                    title: "Качество по СП 542",
                    description: "Защита от БПЛА согласно СП 542.1325800.2024. Только проверенные материалы и технологии в СПб и ЛО"
                  },
                  {
                    icon: <Users className="w-8 h-8" />,
                    title: "Опытная команда",
                    description: "Квалифицированные специалисты с опытом монтажа защиты от дронов в СПб и Ленинградской области"
                  },
                  {
                    icon: <Shield className="w-8 h-8" />,
                    title: "Гарантия защиты",
                    description: "Гарантия на системы защиты от БПЛА и все виды строительных работ от 2 до 5 лет в Санкт-Петербурге и ЛО"
                  }
                ].map((item, i) => (
                    <motion.div
                        key={i}
          ...
          <section className="py-24">
            <div className="container mx-auto px-4">
              ...
              >
                <h2 className="text-4xl md:text-5xl font-bold text-gray-900 dark:text-white mb-6">
                  Защита от БПЛА и строительство под ключ
                </h2>
                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                  Полный спектр строительно-монтажных работ и монтаж антидрон сетки по СП 542 для защиты периметра от дронов
                </p>
              </motion.div>
                ...
                {[
                  {
                    ...
                    description: "Полный комплекс подготовительных работ для строительства в Санкт-Петербурге и Ленинградской области",
                    features: ["Демонтаж конструкций", "Подготовка участка", "Устройство лесов", "Благоустройство территории"],
                    color: "from-blue-500 to-cyan-500"
                  },
                  {
                    title: "Строительство зданий",
                    description: "Возведение промышленных и гражданских объектов под ключ в СПб и Ленинградской области",
                    features: ["Фундаментные работы", "Монтаж конструкций", "Кровельные работы", "Отделка помещений"],
                    color: "from-purple-500 to-pink-500"
                  },
                  {
                    title: "Металлоконструкции",
                    description: "Изготовление и монтаж металлических конструкций любой сложности в Санкт-Петербурге и ЛО",
                  ...
                  {
                    title: "Защита от БПЛА и дронов",
                    description: "Монтаж антидрон сетки по СП 542, защита периметра от беспилотников для ТЭЦ, нефтебаз, аэропортов",
                    features: ["Проектирование защиты", "Монтаж сетки от БПЛА", "Обслуживание систем", "Консультации по СП 542"],
            ...
            faqs={[
              {
                ...
                answer: "Мы предоставляем полный спектр строительно-монтажных работ: подготовительные работы, строительство зданий, монтаж металлоконструкций, теплоизоляцию, а также монтаж антидрон сетки и системы защиты периметра от беспилотников (БПЛА) согласно СП 542.1325800.2024."
              },
              {
                question: "Какой у вас опыт работы?",
                answer: "Компания ООО «ЛЕГИОН» работает на рынке с 2012 года, за это время мы реализовали более 150 проектов в Санкт-Петербурге и Ленинградской области, включая монтаж систем защиты от дронов для промышленных объектов."
              },
              {
                question: "Какие гарантии вы предоставляете?",
                answer: "Мы предоставляем гарантию на все виды работ от 2 до 5 лет в зависимости от типа работ. На системы защиты от БПЛА предоставляем гарантию соответствия СП 542 и обслуживание антидрон сетки."
              },
              {
                question: "Работаете ли вы по всей России?",
                answer: "Да, мы работаем по всей России, включая Санкт-Петербург, Ленинградскую область и другие регионы. Выполняем монтаж защиты от БПЛА для объектов в любой точке страны."
              },
              {
                question: "Какие документы вы предоставляете?",
                answer: "Мы предоставляем весь пакет закрывающих документов, включая договор, акты выполненных работ, сертификаты качества, гарантийные обязательства и паспорт соответствия защиты от БПЛА требованиям СП 542."
              }
            ]}
            title="Часто задаваемые вопросы о защите от БПЛА и строительстве"
            subtitle="Ответы на вопросы о монтаже антидрон сетки, защите периметра от дронов и строительных услугах ЛЕГИОН"
          />
