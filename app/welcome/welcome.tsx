            ...
            <div className="relative container mx-auto px-4 z-10">
              <div className="grid lg:grid-cols-2 gap-12 items-center py-8">
                ...
                >
                  ...
                  >
                    Комплексные решения для безопасности и строительства по всей России — защита от дронов, монтаж металлоконструкций, строительство под ключ.
                  </motion.p>
            ...
            faqs={[
              {
                ...
                answer: "Мы предоставляем полный спектр строительно-монтажных работ: подготовительные работы, строительство зданий, монтаж металлоконструкций, теплоизоляцию, а также современные системы защиты периметра от беспилотников."
              },
              {
                question: "Какой у вас опыт работы?",
                answer: "Компания ООО «ЛЕГИОН» работает на рынке с 2012 года, за это время мы реализовали более 150 проектов в Санкт-Петербурге и Ленинградской области."
              },
              {
                question: "Какие гарантии вы предоставляете?",
                answer: "Мы предоставляем гарантию на все виды работ от 2 до 5 лет в зависимости от типа работ и материалов, использованных при строительстве."
              },
              {
                question: "Работаете ли вы по всей России?",
                answer: "Да, мы работаем по всей России, но специализируемся на проектах в Санкт-Петербурге и Ленинградской области."
              },
              {
                question: "Какие документы вы предоставляете?",
                answer: "Мы предоставляем весь пакет закрывающих документов, включая договор, акты выполненных работ, сертификаты качества и гарантийные обязательства."
              }
            ]}
            title="Часто задаваемые вопросы о строительстве"
            subtitle="Ответы на наиболее популярные вопросы о наших строительных услугах"
          />
