        ...
        <div className="relative overflow-hidden">
                        ...
                        >
                            {[
                                ...
                                >
                                    ...
                                    <div
                                        className={`relative overflow-hidden rounded-2xl p-5 transition-all duration-700 shadow-lg hover:shadow-xl border hover:border-transparent ${
                                            theme === 'dark'
                                        ...
                                        <div className="flex items-start gap-4">
                                            <div
                                                className={`flex-shrink-0 p-3 rounded-xl bg-gradient-to-br ${benefit.gradient} shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all duration-500`}>
                                                {benefit.icon}
                                            </div>
                                            <div>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                        {vacancies.map((vacancy, index) => (
                            ...
                            >
                                ...
                                <div
                                    className={`relative overflow-hidden rounded-[2rem] transition-all duration-500 shadow-xl hover:shadow-2xl border hover:border-transparent ${
                                        theme === 'dark'
                          ...
                          <span
                              className="bg-blue-600/90 backdrop-blur-sm text-white text-xs font-semibold px-3 py-1.5 rounded-lg border border-white/20 shadow-lg">
                            Активная вакансия
                          </span>
                                        </div>
                              ...
                              <span
                                  className="bg-green-500/90 backdrop-blur-sm text-white text-xs font-semibold px-3 py-1.5 rounded-lg border border-white/20 shadow-lg">
                                {vacancy.salary}
                              </span>
                                            </div>
                                        )}
                            ...
                            >
                                ...
                                <div
                                    ...
                                    <div className="relative mb-6">
                                        <div
                                            className={`inline-flex p-4 rounded-2xl bg-gradient-to-br ${benefit.gradient} shadow-xl group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 ${
                                                theme === 'dark' ? 'text-white' : 'text-black'
                                            }`}>
                                            {benefit.icon}
                                        </div>
                                        ...
                                        <div className="absolute -bottom-2 -right-2 flex gap-1">
                                            <div
                                                className={`w-2 h-2 rounded-full bg-gradient-to-r ${benefit.gradient} opacity-60`}/>
                                            <div
                                                className={`w-2 h-2 rounded-full bg-gradient-to-r ${benefit.gradient} opacity-40`}/>
                                        </div>
                                    </div>
            ...
            <section className={`relative py-24 overflow-hidden ${
                ...
                <div className="absolute inset-0 opacity-20 z-0">
                    ...
                    <div
                        className="absolute bottom-20 right-20 w-60 h-60 rounded-full bg-white/10 blur-3xl animate-blob animation-delay-2000"/>
                    <div
                        className="absolute top-1/2 left-1/2 w-60 h-60 rounded-full bg-white/10 blur-3xl animate-blob animation-delay-4000"/>
                </div>
                ...
                <div className="container mx-auto px-4 relative z-10">
                    ...
                    >
                        <div
                            className={`inline-flex items-center gap-2 backdrop-blur-sm rounded-full px-4 py-2 mb-4 border ${
                                theme === 'dark'
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            >
                                <span
                                    className={theme === 'dark' ? 'text-gray-900' : 'text-white'}>Отправить резюме</span>
