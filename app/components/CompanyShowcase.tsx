...
const CompanyShowcase: React.FC = () => {
  ...
  const businessData = {
    ...
    description: "ООО «ЛЕГИОН» - строительно-монтажная компания с 12-летним опытом работы по всей России. Создаем безопасные и надежные пространства для промышленных, коммерческих и жилых объектов. Защищаем от наземных и воздушных угроз с помощью передовых технологий.",
