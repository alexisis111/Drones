...
const CompanyShowcase: React.FC = () => {
  ...
  const businessData = {
    name: "ООО «ЛЕГИОН»",
    description: "ООО «ЛЕГИОН» - строительно-монтажная компания с 12-летним опытом. Создаем безопасные и надежные пространства для промышленных, коммерческих и жилых объектов. Защищаем от наземных и воздушных угроз с помощью передовых технологий.",
    url: "https://xn--78-glchqprh.xn--p1ai/company", // https://легион.рф/company
    logo: "/Logo-1.png",
        ...
        <div className="relative container mx-auto px-4 z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center py-32">
            ...
            >
              ...
              >
                Строительно-монтажная компания с 12-летним опытом в Санкт-Петербурге и Ленинградской области. Создаем безопасные и надежные
